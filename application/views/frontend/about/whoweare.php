...
$page = $this->db->query("select *from pages where name='whoweare'")->row();
?>  
<div class="banner-slider-wrapper overflow-hidden">
  <a href="#who-we-are" class="animate-scroll scroll-down">
  ...
  <div class="no-pad project-detail-info fullscreen-content general-page">
      <div class="overlay-layer" style="background-color: #37442f;"></div>
