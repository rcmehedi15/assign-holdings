...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>asset/backend_template/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>backend"><b><?php echo SITE_NAME; ?></b>BACKEND</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url(); ?>backend/validate_login" method="post" data-toggle="validator">
      <div class="form-group has-feedback">
        <input type="text" name="username" id="username" class="form-control" placeholder="Email/Username" required>
...
<!-- iCheck -->
<script src="<?php echo base_url(); ?>asset/backend_template/plugins/iCheck/icheck.min.js"></script>
