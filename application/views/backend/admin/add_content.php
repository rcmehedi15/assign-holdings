      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" data-toggle="validator" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>content/add">
              <div class="box-body">
                <div class="form-group">
                  <label for="username">Section Code</label>
                  <input type="text" class="form-control" id="section_code" name="section_code" placeholder="Section Code" value="<?php echo $this->input->post('section_code'); ?>" required>
                </div>
