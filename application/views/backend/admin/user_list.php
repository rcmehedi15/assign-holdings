        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <a href="<?php echo base_url(); ?>admin/add_user"><button type="button" class="btn  btn-danger btn-flat pull-right"><i class="fa fa-plus margin-r-5"></i>Add New User</button></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				<?php
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="hidden-xs">Email/Username</th>
                  <th>Name</th>
				  ...
				  <td>
					<div class="btn-group">
					  ...
					  <ul class="dropdown-menu" role="menu">
						...
						<li><a href="<?php echo base_url(); ?>admin/edit_user/<?php echo $value->id; ?>">Edit</a></li>
						<li><a href="<?php echo base_url(); ?>admin/delete_user/<?php echo $value->id; ?>" onclick="return confirm('Are you sure?')">Delete</a></li>
						<!--<li class="divider"></li>
